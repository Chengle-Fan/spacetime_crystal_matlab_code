...
%DEMO08_FHS_CHERN_THOULESS_PUMP Algorithm benchmark on a Rice-Mele pump.
%
% A Rice-Mele cycle provides a compact, independently quantized validation
% of the topology routine. The modulation phase is a synthetic dimension.
% It is not a Chern-number reproduction for demos 01--07's continuum
% Maxwell space-time medium.
...
outputFile = fullfile(rootDir,'output', ...
    'demo08_fhs_chern_thouless_pump.png');
try
