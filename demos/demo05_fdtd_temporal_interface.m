...
%DEMO05_FDTD_TEMPORAL_INTERFACE Wave splitting at one time boundary.
%
% A complex Gaussian wave packet permits clean forward/backward
% decomposition. The numerical amplitudes are compared with the analytic
% Morgenthaler coefficients.
...
outputFile = fullfile(rootDir,'output', ...
    'demo05_fdtd_temporal_interface.png');
try
